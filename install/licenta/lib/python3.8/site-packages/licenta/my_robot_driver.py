...
class MyRobotDriver:
    ...
    def cmd_vel_callback(self, twist):
        ...
        #control pe baza cinematicii robotului diff 
    ...
    def step(self):
        ...
        print(desired_ang)
        theta_difference = fmod(desired_ang - current_position[2] + 180, 360)# - 360
...
#    self.__left_motor.setVelocity(left_motor_velocity/5)
#    self.__right_motor.setVelocity(right_motor_velocity/5)
